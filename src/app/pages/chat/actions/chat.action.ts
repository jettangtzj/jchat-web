export const chatAction = {
	...
	addGroupKeeper: '[chat] add group keeper',
	delGroupKeeper: '[chat] delete group keeper',
	addGroupKeeperEvent: '[chat] add group keeper event',
	delGroupKeeperEvent: '[chat] delete group keeper event',
